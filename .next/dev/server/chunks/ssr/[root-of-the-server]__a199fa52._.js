...
async function changePassword(data) {
    ...
    if (!response.ok) {
        const err = await response.json().catch(()=>({}));
        throw new Error(err.new_password_confirm || err.new_password || err.detail || 'Ошибка смены пароля');
    }
}
;
}),
...
function AuthProvider({ children }) {
    ...
    const login = async (credentials)=>{
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["login"])(credentials);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a199fa52._.js.map